...
| setFaceDetectionBox       | `enable: Bool`                                                      | `true` or `false`                                                                 | void        | Set to enable/disable a detection box when face detected.   
...
| onFaceDetected | `x: Int, y: Int, width: Int, height: Int, leftEyeOpenProbability: Float?, rightEyeOpenProbability: Float?, smilingProbability: Float?, headEulerAngleX: Float?, headEulerAngleY: Float?, headEulerAngleZ: Float?`  Must have started capture type of face. Emi the [face analysis](#face-analysis)
